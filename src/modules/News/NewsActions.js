...
export const NewsActions = ({data, getNews}) => {
    const [content, setContent] = useState('default')

    const deleteItem = async () => {
        NewsStore.deleteNew(data.id)

        await fetch(`http://localhost:5000/DeleteNewsId?id=${data.id}`, {
            method: 'DELETE',
        })
    ...
    return (
        <div className={cn({
            ...
            [styles.newsItemActionsExpanded]: content === 'expanded',
            [styles.newsItemActionsDelete]: content === 'delete',
        })}>
            <div className={styles.newsItemActionsInner}>
                {
                    content === 'default' && (
                        <button
                            className={cn(styles.newsItemActionsBtn, styles.newsItemActionsBtnMore)}
                            type={'button'}
                ...
                }
                {
                    content === 'expanded' && (<>
                        ...
                        <button
                            className={cn(styles.newsItemActionsBtn, styles.newsItemActionsBtnRed)}
                            type={'button'}
                        ...
                        <button
                            className={cn(styles.newsItemActionsBtn, styles.newsItemActionsBtnRed, styles.newsItemActionsBtnClose)}
                            type={'button'}
                ...
                }
                {
                    content === 'delete' && (<>
                        <button
                            className={cn(styles.newsItemActionsBtn)}
                            type={'button'}
                            onClick={deleteItem}
                        >
                            <svg width="25" height="18" viewBox="0 0 25 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M24.4191 0.581067C23.6456 -0.193933 22.3895 -0.193445 21.615 0.581067L8.99467 13.2095L3.38548 7.59696C2.61094 6.82196 1.35544 6.82196 0.580901 7.59696C-0.193634 8.37196 -0.193634 9.62822 0.580901 10.4032L7.59209 17.4186C7.97912 17.8059 8.4866 18 8.99414 18C9.50167 18 10.0096 17.8064 10.3967 17.4186L24.4191 3.38728C25.1936 2.61282 25.1936 1.35602 24.4191 0.581067Z" fill="#277EFB"/>
                            </svg>
                        </button>
                        <button
                            className={cn(styles.newsItemActionsBtn, styles.newsItemActionsBtnRed, styles.newsItemActionsBtnClose)}
